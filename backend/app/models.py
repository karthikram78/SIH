...
class User(Base):
    ...
    lat = Column(Float, nullable=False, default=10.8271)
    lng = Column(Float, nullable=False, default=78.6890)
...
class Cooperative(Base):
    ...
    monthly_jobs_count = Column(Integer, default=0)
    monthly_earnings_total = Column(Float, default=0.0)
    welfare_fund_balance = Column(Float, default=0.0)
...
class Worker(Base):
    ...
    # Location
    lat = Column(Float, nullable=False, default=10.8290)
    lng = Column(Float, nullable=False, default=78.6810)
    address = Column(String(255), nullable=False)
    city = Column(String(100), nullable=False, default="Tiruchirappalli")
    pincode = Column(String(10), nullable=False, default="620003")
    landmark = Column(String(255), nullable=True)
